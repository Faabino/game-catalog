...
export class GameModel {
  ...
  findByPlatformSlug(slug: string): Promise<Game[] | null> {
    return this.collection.find({ platform_slug: slug }).toArray();
  }
  ...
  updateOne(slug: string, newName: string): Promise<"game_not_found" | "ok"> {
